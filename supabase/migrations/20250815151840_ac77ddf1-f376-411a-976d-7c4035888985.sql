...
-- Alterar tabela documentos para substituir categoria por classificacao e remover confidencial
ALTER TABLE public.documentos 
  ADD COLUMN IF NOT EXISTS classificacao TEXT DEFAULT 'interna',
  DROP COLUMN IF EXISTS confidencial;

-- Atualizar dados existentes para migrar categoria para classificacao
