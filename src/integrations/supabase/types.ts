  ...
  public: {
    Tables: {
      ...
      endpoint_agents: {
        ...
        Relationships: [
          {
            foreignKeyName: "endpoint_agents_ativo_id_fkey"
            columns: ["ativo_id"]
            isOneToOne: false
            referencedRelation: "ativos"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "endpoint_agents_empresa_id_fkey"
            columns: ["empresa_id"]
            isOneToOne: false
            referencedRelation: "empresas"
            referencedColumns: ["id"]
      ...
      endpoint_enrollment_tokens: {
        ...
        Relationships: [
          {
            foreignKeyName: "endpoint_enrollment_tokens_empresa_id_fkey"
            columns: ["empresa_id"]
            isOneToOne: false
            referencedRelation: "empresas"
            referencedColumns: ["id"]
      ...
      endpoint_inventory_snapshots: {
        ...
        Relationships: [
          {
            foreignKeyName: "endpoint_inventory_snapshots_agent_id_fkey"
            columns: ["agent_id"]
            isOneToOne: false
            referencedRelation: "endpoint_agents"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "endpoint_inventory_snapshots_empresa_id_fkey"
            columns: ["empresa_id"]
            isOneToOne: false
            referencedRelation: "empresas"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      mark_offline_endpoints: { Args: never; Returns: undefined }
