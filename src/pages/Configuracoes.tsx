        ...
        <TabsList>
          {isSuperAdmin && (
            <TabsTrigger value="empresas" className="flex items-center gap-2">
              ...
              <span className="hidden 2xl:inline">Empresas</span>
            </TabsTrigger>
          )}
          {isSuperAdmin && (
